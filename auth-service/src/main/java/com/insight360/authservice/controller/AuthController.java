...
package com.insight360.authservice.controller;

import com.insight360.authservice.config.JwtUtil;
...
public class AuthController {
    ...
    public ResponseEntity<Map<String,String>> login(@RequestParam String username, @RequestParam String password) {
        String url = "http://user-service:8082/api/users/by-username/" + username;
        try {
